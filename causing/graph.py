...
def create_graphs(graph_json):
    ...
    mediation_graph = create_and_save_graph(
        ...
        False, dir_path, "AME", base_var, model_dat_condition)
    ...
    direct_hat_graph = create_and_save_graph(
        ...
        (mx_hat, idx, None),
        (my_hat, idy, None),
        False, dir_path, "EDE", base_var, model_dat_condition)
    ...
    mediation_hat_graph = create_and_save_graph(
        ...
        (eyx_hat, fdx, exj_hat),
        (eyy_hat, fdy, eyj_hat),
        False, dir_path, "EME", base_var, model_dat_condition)
    ...
    direct_tval_graph_0 = create_and_save_graph(
        ...
        (utils.tvals(my_hat, my_hat_std),
         idy,
         None),
        2, dir_path, "ED0", base_var, model_dat_condition, lambda x: abs(x))
    # EM0 Parms
    ...
    mediation_tval_graph_0 = create_and_save_graph(
        ...
        2, dir_path, "EM0", base_var, model_dat_condition, lambda x: abs(x))
    ...
    direct_tval_graph_1 = create_and_save_graph(
        ...
        ((utils.tvals(my_hat - my_theo,
         ...
         idy,
         None),
        2, dir_path, "ED1", base_var, model_dat_condition, lambda x: -abs(x))
    ...
    for i in range(min(tau, show_nr_indiv)):
        ...
        direct_indiv_graph = create_and_save_graph(
            ...
            True, dir_path, "IDE" + "_" + str(i), base_var, model_dat_condition)
